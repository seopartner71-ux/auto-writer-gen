...
.cm-filters__group b{color:#101B2B;font-size:15px;line-height:1.4;font-weight:var(--font-weight-semibold)}
.cm-filters label{color:#1B2A3D;font-size:14px;line-height:1.45;font-weight:var(--font-weight-regular)}
.cm-toolbar{font-size:15px;line-height:1.45}
...
.page-article{color:#374151;font-size:clamp(16px,1.35vw,18px);line-height:var(--body-line-height)}
.page-article h1,.page-article h2,.page-article h3{color:#101B2B}
.page-article p{margin:0 0 1.15em}
...
.site-header__tagline{font-size:12px;line-height:1.4;letter-spacing:.03em}
...
.lsh-facts article{display:flex;gap:16px;padding:32px 20px;border-right:1px solid var(--pm-line)}.lsh-facts article:last-child{border-right:0}.lsh-facts h2{font-size:15px;line-height:1.35;font-weight:var(--font-weight-semibold);margin:0 0 6px;color:#101B2B}.lsh-facts p{font-size:13px;line-height:1.5;margin:0;color:#66758A}.lsh-fact-icon{width:32px;height:32px;flex:0 0 32px;border:2px solid #FF5A1F;color:#FF5A1F;display:grid;place-items:center;font-size:12px;font-weight:var(--font-weight-bold);transform:rotate(45deg)}.lsh-fact-icon::first-line{transform:rotate(-45deg)}
...
.lsh-category-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:1px;background:#DDE3EC;border:1px solid #DDE3EC}.lsh-category{background:#fff;padding:28px;min-height:250px}.lsh-category h3{font-size:clamp(1.25rem,2vw,1.625rem);line-height:1.25;font-weight:var(--font-weight-semibold);margin:0 0 16px;color:#101B2B}.lsh-category ul{list-style:none;padding:0;margin:0 0 20px}.lsh-category li+li{margin-top:9px}.lsh-category li a{color:#536277;text-decoration:none}.lsh-category__all{display:inline-block;margin-top:auto;color:#1F49C6;font-weight:var(--font-weight-semibold);text-decoration:none}
.lsh-assortment{display:grid;grid-template-columns:repeat(3,1fr);border-top:1px solid #DDE3EC;border-left:1px solid #DDE3EC}.lsh-assortment a{min-height:62px;padding:15px 18px;display:flex;align-items:center;justify-content:space-between;gap:14px;border-right:1px solid #DDE3EC;border-bottom:1px solid #DDE3EC;color:#26374E;text-decoration:none;font-weight:var(--font-weight-semibold);line-height:1.4}.lsh-assortment a:hover,.lsh-assortment a:hover b{color:#1F49C6}.lsh-assortment b{color:#94A0B2}
.lsh-section--selector{background:#122B68;color:#fff}.lsh-selector{display:grid;grid-template-columns:minmax(260px,.65fr) minmax(0,1.35fr);gap:64px;align-items:start}.lsh-selector h2{color:#fff}.lsh-selector>div:first-child>p:last-child{color:#D7E2FB;line-height:1.65}.lsh-selector__links{display:grid;grid-template-columns:repeat(2,1fr);border-top:1px solid rgba(255,255,255,.22);border-left:1px solid rgba(255,255,255,.22)}.lsh-selector__links a{display:flex;align-items:center;justify-content:space-between;gap:12px;min-height:58px;padding:14px 16px;border-right:1px solid rgba(255,255,255,.22);border-bottom:1px solid rgba(255,255,255,.22);color:#fff;text-decoration:none;font-weight:var(--font-weight-semibold);line-height:1.4}.lsh-selector__links a:hover{background:rgba(255,255,255,.08)}
...
.lsh-faq{display:grid;grid-template-columns:minmax(220px,.55fr) minmax(0,1.45fr);gap:64px;align-items:start}.lsh-faq details{border-top:1px solid #DDE3EC}.lsh-faq details:last-child{border-bottom:1px solid #DDE3EC}.lsh-faq summary{padding:20px 36px 20px 0;cursor:pointer;color:#16202F;font-weight:var(--font-weight-semibold);line-height:1.45;position:relative;list-style:none}.lsh-faq summary::-webkit-details-marker{display:none}.lsh-faq summary::after{content:"+";position:absolute;right:4px;top:17px;color:#1F49C6;font-size:22px}.lsh-faq details[open] summary::after{content:"−"}.lsh-faq details p{margin:0;padding:0 36px 20px 0;color:#536277;line-height:1.65}
.lsh-contact{background:#122B68;color:#fff;padding:38px 0}.lsh-contact>.pm-wrap{display:flex;align-items:center;justify-content:space-between;gap:24px}main.page .lsh-contact h2{color:#fff;margin:0}.lsh-contact p{color:#D7E2FB;margin:8px 0 0}.lsh-contact>.pm-wrap>div:last-child{display:flex;flex-direction:column;align-items:flex-end;gap:5px}.lsh-contact a{color:#fff;font-weight:var(--font-weight-semibold);text-decoration:none}
