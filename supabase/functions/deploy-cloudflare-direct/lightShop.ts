...
.site-header__brand{font-weight:800;letter-spacing:0;font-size:24px;text-transform:uppercase}
...
.lsh-hero__copy{max-width:760px}.lsh-kicker{display:inline-flex;margin:0 0 18px;color:#1F49C6;font-size:13px;font-weight:800;text-transform:uppercase;letter-spacing:.08em}
main.page .lsh-hero h1{margin:0 0 22px;color:#101B2B;font-size:clamp(42px,5.2vw,68px);line-height:1.06;font-weight:800;letter-spacing:0}
...
.lsh-hero__catalog{background:#fff;border-top:4px solid #1F49C6;padding:26px 28px}.lsh-hero__catalog>p{margin:0 0 14px;font-size:13px;font-weight:800;text-transform:uppercase;color:#78869A;letter-spacing:.07em}.lsh-hero__catalog ul{list-style:none;margin:0;padding:0}.lsh-hero__catalog li+li{border-top:1px solid #E5E9EF}.lsh-hero__catalog a{display:flex;justify-content:space-between;gap:16px;padding:14px 0;color:#16202F;text-decoration:none;font-weight:700}.lsh-hero__catalog a:hover{color:#1F49C6}
...
.lsh-copy,.lsh-section{padding:72px 0}.lsh-copy h2,.lsh-section h2,.lsh-contact h2{font-size:32px;margin:0 0 14px;letter-spacing:0;color:#101B2B}.lsh-copy p{max-width:920px;margin:0;color:#536277;line-height:1.75}.lsh-section--soft{background:#F5F7FA}.lsh-overline{margin:0 0 10px!important;color:#1F49C6!important;font-size:12px!important;font-weight:800;text-transform:uppercase;letter-spacing:.08em}
...
@media(max-width:960px){.lsh-hero__inner{grid-template-columns:1fr}.lsh-facts__grid{grid-template-columns:repeat(2,1fr)}.lsh-facts article:nth-child(2){border-right:0}.lsh-category-grid,.lsh-guides{grid-template-columns:1fr}.lsh-products{grid-template-columns:repeat(2,1fr)}}
@media(max-width:760px){.site-nav{display:none}.site-nav.open{display:flex}}
@media(max-width:600px){.lsh-hero__inner{min-height:0;padding:50px 0}main.page .lsh-hero h1{font-size:38px}.lsh-facts__grid{grid-template-columns:1fr}.lsh-facts article{border-right:0;border-bottom:1px solid var(--pm-line)}.lsh-products{grid-template-columns:1fr}.lsh-heading{align-items:flex-start;flex-direction:column}.lsh-contact>.pm-wrap{align-items:flex-start;flex-direction:column}.lsh-contact>.pm-wrap>div:last-child{align-items:flex-start}}
`;
