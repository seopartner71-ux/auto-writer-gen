...
- ЗАПРЕЩЕНО вставлять термины внутрь тегов <h1>, <h2>, <h3>, <h4>. Термины вставлять ТОЛЬКО в теги <p>. Если термин не вписывается в абзац — пропустить его.
- ЗАПРЕЩЕНО использовать английские слова (Honestly, Look, Note, Important и т.д.) в русском тексте. Только русский язык.
- ЗАПРЕЩЕНО оставлять незаконченные предложения, обрывы на полуслове или висящие союзы в конце.`;
