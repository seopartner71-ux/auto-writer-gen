...
- Весь вывод - ИСКЛЮЧИТЕЛЬНО чистый Markdown. Для жирного используй **текст**, для курсива *текст*, для ссылок [текст](url). НИКОГДА не используй HTML-разметку. Исключения: комментарий <!-- FAQ Schema --> и тег <script type="application/ld+json"> для FAQ микроразметки в конце статьи.
