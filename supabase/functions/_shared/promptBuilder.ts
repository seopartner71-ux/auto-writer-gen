...
${seoList.map((k, i) => `${i + 1}. "${k}" — минимум 1 точное вхождение в тексте (склонение и разбиение знаками препинания разрешено)`).join("\n")}
...
- Если ключ не вставлен — статья считается невалидной.\n` : "";
