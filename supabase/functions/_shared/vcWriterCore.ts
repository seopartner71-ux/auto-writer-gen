...
- В ТОП-1 (и опционально ТОП-2) карточке добавь H4 «#### Сильные стороны <Название>» (3 буллета) и H4 «#### Потенциальные зоны роста» (2 буллета). Это даёт «глубину» рейтингу.
...
4-6 вопросов. Каждый вопрос и ответ - ОДНИМ абзацем (вопрос с "?" -> сразу ответ в том же абзаце). НЕ "Q:/A:", НЕ блок-цитата. ПРАВИЛО Direct Answer First: первое предложение ответа должно содержать ЛИБО конкретное число/единицу/процент, ЛИБО имя реального стандарта/инструмента/документа. Перечисление общих слов «параметры, условия, материалы» без числа = брак.

После FAQ строкой:
Примечание: Цены указаны для ознакомления на основе открытых данных <год> и могут корректироваться производителями.

H2 "Заключение"
1-3 предложения. Должны содержать КОНКРЕТНУЮ рекомендацию по сегментам ("Если бюджет первичен - <бренд>; если критичная нагрузка - <другой бренд>"), а не общие слова «изучайте отзывы, сравнивайте». Допустим один финальный вопрос читателю в самом конце («А как вы выбираете <предмет>?»), но это не классический P.S.-блок.
