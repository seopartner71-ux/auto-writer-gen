...
ФОРМАТ: без жирного (никаких **). Используй ТОЛЬКО обычный дефис "-". Длинное тире "—" и среднее тире "–" ЗАПРЕЩЕНЫ - везде ставь дефис "-".
...
LANGUAGE: write strictly in English. No bold (**). Use ONLY the plain hyphen "-". Em-dash "—" and en-dash "–" are FORBIDDEN - always write hyphen "-".
