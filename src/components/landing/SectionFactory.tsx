          ...
          <div className="rounded-2xl bg-[#06060b]/90 p-6 sm:p-8">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex gap-6">
                ...
                <div className="text-right">
                  <p className="text-2xl font-black text-muted-foreground/60" style={{ letterSpacing: "-0.06em" }}>{articles.length - (published % articles.length)}</p>
                  <p className="text-[9px] font-tech text-muted-foreground/60 uppercase">{t("lp.factoryQueue")}</p>
                </div>
              </div>
            </div>
