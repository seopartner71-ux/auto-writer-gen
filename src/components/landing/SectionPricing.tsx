  ...
  const plans = [
    ...
    },
    {
      ...
      features: getFeatures("pro", [
        ...
        { text: isEn ? "2 users in account" : "2 пользователя в аккаунте", included: true },
        { text: isEn ? "Site Factory / Programmatic SEO" : "Site Factory / Programmatic SEO", included: true },
        { text: isEn ? "API access (basic)" : "API доступ (базовый)", included: true },
