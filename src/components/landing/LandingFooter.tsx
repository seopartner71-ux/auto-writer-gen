          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-brand tracking-tight">
                SERP<span className="bg-clip-text text-transparent bg-gradient-to-r from-primary to-[#3b82f6]">blueprint</span> <span className="text-xs text-muted-foreground/40 font-mono">v2.0</span>
              </span>
            </div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-[11px] font-tech text-emerald-400/60 tracking-wide">
                {t("lp.footerStatus")}
              </span>
            </div>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-x-8 gap-y-3">
            {navLinks.map((link, i) => (
              <button
                ...
                className="text-sm text-muted-foreground/40 hover:text-foreground/70 transition-colors duration-200"
              >
                {link.label}
              </button>
            ))}
