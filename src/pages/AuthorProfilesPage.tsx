...
const GOGETLINKS_DEFAULTS = {
  voice_tone: "expert",
  system_instruction: `Вы пишете заметки под быстрые ссылки. Ваша задача - создать максимально естественный контекст для ссылки в 1000-1500 знаков. Стиль - 'заметка в газету'. Очень высокая плотность смысла, никаких вступлений 'в современном мире'. Всё четко, по делу, с акцентом на пользу здесь и сейчас.
...
6. Анкоры: естественные, без спамных коммерческих фраз.`,
  ...
  description: "Краткий, емкий, быстрый.",
};
